...
const Header = () => {
  ...
  useEffect(() => {
    ...
    setBagCount(reservations.length);
    // Listen for changes to localStorage (e.g., new reservations)
    const handleStorage = () => {
      const updated = JSON.parse(localStorage.getItem('reservations') || '[]');
      setBagCount(updated.length);
    };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link to="/profile" className="relative p-2 text-gray-700 hover:text-green-600 transition-colors">
